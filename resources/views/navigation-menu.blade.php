...
<div>
    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-30">
        <div class="flex flex-wrap justify-between items-center">
          <div class="flex justify-start items-center">
            ...
            <a href="/" class="flex items-center justify-between mr-4">
              <img
                ...
                alt="Flowbite Logo"
              />
              <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">S.C.H.O.L.A.R.</span>
            </a>
          </div>
          <div class="flex justify-between items-center lg:order-2">
            ...
            <button
              type="button"
              data-dropdown-toggle="teams-Dropdown"
              class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            >
              <span class="sr-only">View notifications</span>
              <!-- Icon -->
    ...
    <!-- Teams menu -->
    <div id="teams-Dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
        @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
            <x-responsive-nav-dropdown-link href="{{ route('teams.create') }}" :active="request()->routeIs('teams.create')">
                {{ __('Create New Team') }}
            </x-responsive-nav-dropdown-link>
        @endcan
        @if (Auth::user()->allTeams()->count() >= 1)
        
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="TeamsDefaultButton">
        @foreach (Auth::user()->allTeams() as $team)
        <li><x-switchable-team :team="$team" component="responsive-nav-link" /></li>
        @endforeach
        </ul>
        <x-responsive-nav-dropdown-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}" :active="request()->routeIs('teams.show')">
        {{ __('Team Settings') }}
        </x-responsive-nav-dropdown-link>
        @endif
    </div>
...
<div class="text-center">
 ...
 <div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
     <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400my-6 my-6"></h5>
